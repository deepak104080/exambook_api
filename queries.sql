...
-- create examlog table
-- insert data in examlog table

ALTER TABLE examlog ADD COLUMN questions JSON; 


CREATE TABLE examlog_details (examlog_id INT NOT NULL, user_id INT NOT NULL , exam_id INT NOT NULL, qsid INT NOT NULL, answer INT NOT NULL, correctstatus INT NOT NULL );


INSERT INTO examlog_details (examlog_id, user_id  , exam_id , qsid , answer , correctstatus ) VALUES (1, 2, 2, 5, 2, 0);

--  DDL - CREATE DB, CREATE TABLE
--  DML - CRUD
